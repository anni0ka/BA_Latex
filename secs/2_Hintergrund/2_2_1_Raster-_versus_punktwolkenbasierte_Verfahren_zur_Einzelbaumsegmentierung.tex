...
Bei der Segmentierung von Bäumen auf Basis von LiDAR-Daten wird grundlegend zwischen raster- und punktwolkenbasierten Verfahren unterschieden. Beide Ansätze sind schematisch in Abbildung \ref{fig:raster-vs-pointcloud} präsentiert. Im Folgenden werden die beiden Ansätze gegenübergestellt und deren Eignung für den Kontext urbaner Bäume eingeordnet.
\begin{figure}[htbp]
    \centering
