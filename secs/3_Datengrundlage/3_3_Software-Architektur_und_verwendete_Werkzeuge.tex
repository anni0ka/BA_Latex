...
Abseits der Codeumgebung war eine visuelle Qualitätskontrolle der räumlichen Daten unerlässlich. Hierfür wird die Open-Source-Software \textit{CloudCompare (Version 2.13.2)} \cite{zotero-item-57} eingesetzt, die ein performantes Rendering der ALS-Datensätze ermöglicht.